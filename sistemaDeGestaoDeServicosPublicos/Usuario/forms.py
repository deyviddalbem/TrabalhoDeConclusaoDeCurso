...
class CadastroEnderecoForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['cep'].widget.attrs = {'class':'form-group form-control','type':'text','placeholder':'digite seu CEP'}
        self.fields['logradouro'].widget.attrs = {'class':'form-group form-control','type':'text','placeholder':'informe seu logradouro'}
        self.fields['enderecoNumero'].widget.attrs = {'class':'form-group form-control','type':'text','placeholder':' insira o Número do imóvel'}
        self.fields['complemento'].widget.attrs = {'class':'form-group form-control','type':'text','placeholder':'informe o Complemento'}
        self.fields['bairro'].widget.attrs = {'class':'form-group form-control','type':'text','placeholder':'informe o Bairro'}
        self.fields['observacao'].widget.attrs = {'class':'form-group form-control','type':'text','placeholder':'insira uma Observação, se houver'}
        self.fields['municipio'].widget.attrs = {'class':'form-group form-control','type':'text','placeholder':'insira o municipio'}
        self.fields['estado'].widget.attrs = {'class':'form-group form-control','type':'text','placeholder':'informe o estado'}  
